...
enum class SystemCallNr : uint64_t {
	...
	FILE_GETATTR,                 // i386 x64 x32 aarch64
	FILE_SETATTR,                 // i386 x64 x32 aarch64
	...
	GETXATTRAT,                   // i386 x64 x32 aarch64
	GTTY,                         // i386
	IDLE,                         // i386
	...
	LISTXATTRAT,                  // i386 x64 x32 aarch64
	...
	OPEN_TREE_ATTR,               // i386 x64 x32 aarch64
	...
	REMOVEXATTRAT,                // i386 x64 x32 aarch64
	RENAME,                       // i386 x64 x32
	...
	SETXATTRAT,                   // i386 x64 x32 aarch64
	SGETMASK,                     // i386
