#ifndef CLUES_DIRENTRY_HXX
#define CLUES_DIRENTRY_HXX
 ...
 * \details
 * 	The stored data is only valid as long as the Directory object is was
...
public: // functions
	...
	auto type() const
	{
		return static_cast<Type>(m_entry->d_type);
	}
