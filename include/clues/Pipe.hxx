#ifndef CLUES_PIPE_HXX
#define CLUES_PIPE_HXX
 ...
 *	one for writing to. To make use of it it needs to inherited to a child
 *	process or otherwise be used e.g. as a wakeup mechanism for select()
 *	calls etc.
 **/
class Pipe
{
public: // functions
	...
	/**
	 * \brief
	 *	Maximum number of bytes that can be transmitted over as a
	 *	single message
	 * \details
